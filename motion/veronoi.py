...
class VoronoiGraph:
    ...
    def _edge_crosses_points(self, v1, v2):
        ...
        for point in self.points:
            ...
            if dist < 1e-6:  # Considera que cruza se a distância for muito pequena
                print(f"Aresta entre {v1} e {v2} cruza o ponto {point}")
                return True
        print(f"Aresta entre {v1} e {v2} é válida")
        return False
    ...
    def add_point(self, point, point_name):
        ...
        print(f"Ponto {point_name} adicionado ao grafo na posição ({point.x}, {point.y})")
    ...
    def connect_external_points(self, point1, point2, name1, name2):
        ...
        """
        print(f"Tentando conectar {name1} ({point1.x}, {point1.y}) a {name2} ({point2.x}, {point2.y})")
        ...
        if not self._edge_crosses_points((point1.x, point1.y), (point2.x, point2.y)):
            ...
            print(f"Conectando {name1} ({point1.x}, {point1.y}) a {name2} ({point2.x}, {point2.y}) com distância {dist}")
        else:
            print(f"Aresta entre {name1} e {name2} não é válida")
