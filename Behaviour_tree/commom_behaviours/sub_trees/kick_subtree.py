...
def get_kick_subtree(robot: Bob) -> py_trees.trees.BehaviourTree:
    ...
    kick_subtree = py_trees.composites.Sequence(
        "chutar no gol",
        True,
        children=[posse_da_bola, visibilidade_gol, distancia_gol, calculate_linear_position, alinhamento_linear, calculate_angular_position, alinhamento_angular, chutar_gol]
    )
